...
const Card = ({ width, h1, start, para, hover = "false" }) => {
  return (
    <motion.div
      ...
      className={`bg-[#27272d] p-5 rounded-xl ${width} min-h-[30rem] mt-24 flex flex-col justify-between`}
    >
      ...
      <div className="down w-full mt-50">
        {start === true && (
          <>
            <h1 className="text-[7rem] pb-10 font-semibold tracking-tight leading-none">
              Start a Project
            </h1>
